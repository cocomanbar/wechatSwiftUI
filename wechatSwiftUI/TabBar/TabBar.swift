...
struct TabBar: View {
    ...
    var body: some View {
        ...
        NavigationView {
            ...
            .navigationTitle(TabBarItemDatable.itemDatable(selected: selected).title)
            .navigationBarTitleDisplayMode(.large)
            .navigationBarHidden(TabBarItemDatable.itemDatable(selected: selected).navigationBarHidden)
